...
BRANCH: typing.Final[str] = "master"
...
DB_HOST: typing.Final[str] = "c-c9q51j0c7jd7a2sej0kf.rw.mdb.yandexcloud.net:6432"
DB_NAME: typing.Final[str] = "busy-db-prod"
DB_USER: typing.Final[str | None] = os.getenv("DB_USER")
DB_PASS: typing.Final[str | None] = os.getenv("DB_PASS")

REDIS_URL: typing.Final[str] = "172.17.0.2"
...
VOX_MAIN_NUMBER: typing.Final[str] = "79993331265"
...
DATABASE_ENGINE_ARGS: typing.Final[typing.Any] = {"pool_pre_ping": True, "pool_size": 370, "max_overflow": 0}
